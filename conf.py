...
BLOG_AUTHOR = "Gautam Sharma"  # (translatable)
BLOG_TITLE = "My Portfolio"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://sharmagautam.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://example.com/"
BLOG_EMAIL = "gautamsharma2813@gmail.com"
BLOG_DESCRIPTION = "My space showcasing my projects and blog"  # (translatable)
...
# (translatable)
CONTENT_FOOTER = 'Contents &copy; {date}         <a href="mailto:{email}">{author}</a> - Powered by <a href="https://python.org" rel="nofollow">Python</a>         {license}'
